...
//                 onChange={(e) => handleDurationChange(m.key as ModeKey, e.target.value)}
...
//             <span className="text-[#2b2a26]">Sesi sebelum long break</span>
//             <input
//               type="number"
//               min={2}
//               max={8}
...
//           </label>
//           <label className="flex items-center justify-between text-sm">
//             <span className="text-[#2b2a26]">Target sesi focus harian</span>
//             <input
//               type="number"
//               min={1}
//               max={20}
...
//             <div>
//               <div className="text-[#2b2a26]">Auto-lanjut sesi berikutnya</div>
//               <div className="text-[11px] text-[#9a988f] mt-0.5">
//                 Langsung mulai sesi selanjutnya tanpa perlu klik Start
//               </div>
//             </div>
...
//           <div className="flex items-center justify-between text-sm">
//             <div>
//               <div className="text-[#2b2a26]">Suara notifikasi</div>
//               <div className="text-[11px] text-[#9a988f] mt-0.5">
//                 Bunyi chime saat sesi selesai
//               </div>
//             </div>
...
//             }`}
//           >
//             {confirmingReset ? "Yakin? Klik lagi untuk hapus semua data" : "Hapus semua data"}
//           </button>
//         </div>
//       </div>
//     </div>
