...
//         0,
//         (minutesSinceMidnight(Date.now()) / 60 - 2) * HOUR_HEIGHT,
//       );
...
//   const dayTimelineSessions = usingSampleData
//     ? buildSampleSessions()
//     : todayRealSessions;
...
//   const todayFocusCount = todayRealSessions.filter(
...
//                     {new Date(nowTick).toLocaleDateString("id-ID", {
//                       weekday: "long",
//                       day: "numeric",
//                       month: "long",
//                     })}
...
//                       <span
//                         style={{ ...styles.legendDot, background: m.color }}
//                       />
//                       {m.label}
//                     </div>
//                   ),
