...
//   const { sessions, dailyGoal } = usePomodoro();
...
//     const sessionsToGoal = Math.max(0, dailyGoal - completedToday);
...
//   const goalPct = Math.min(100, Math.round((stats.completedToday / dailyGoal) * 100));
...
//                 {stats.completedToday} / {dailyGoal} sessions
//               </span>
//             </div>
