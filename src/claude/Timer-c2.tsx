...
//     MODES[2].minutes,
//   ]);
//   // One countdown per mode, so switching tabs doesn't wipe out progress on
//   // whichever mode you're leaving.
//   const [secondsLeftByMode, setSecondsLeftByMode] = useState<number[]>(() =>
...
//     // Only switch which tab is active and pause — the seconds for both the
//     // tab you're leaving and the one you're entering stay exactly as they were.
//     setMode(key);
//     setIsRunning(false);
//   }
